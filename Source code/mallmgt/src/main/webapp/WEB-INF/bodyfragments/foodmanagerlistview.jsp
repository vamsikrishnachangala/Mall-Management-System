...
<table class="table bg-light text-dark" style="margin-top: 10px;">
  ...
  <c:forEach items="${list}" var="li" varStatus="u">
    <tr>     
      ...
      <td>${li.dob}</td>
      <td>      
      <a href="${pageContext.request.contextPath}/foodmanagerEdit?id=${li.id}"><i class="fas fa-pen"></i></a>
      <a href="${pageContext.request.contextPath}/foodmanagerDelete?id=${li.id}&stallId=${stallId}"><i class="fas fa-trash"></i></a>      
      </td>
    </tr>
   </c:forEach>
  </tbody>

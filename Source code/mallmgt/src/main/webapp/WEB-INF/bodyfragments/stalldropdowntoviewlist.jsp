        ...
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
           ...
           <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Choose Stall</h3>
            ...
            <sf:form method="post" action="${pageContext.request.contextPath}/foodMenuItemList" modelAttribute="form">
            <sf:input type="hidden" id="id" class="form-control form-control-lg" path="id" name="id" value="${form.id}"/>
  			...
  			<c:otherwise>
             <div class="mt-4 pt-2">
                <input class="btn btn-primary btn-lg" type="submit" value="View Menu Item" />
              </div>
  			</c:otherwise>
			</c:choose> 
